...
感谢所有报告者的卓越工作！希望你们喜欢阅读。借此机会，祝大家 2010 年新年快乐、事业成功。

请注意，涵盖 2010 年 1 月至 3 月期间的提交截止日期为 2010 年 4 月 15 日。

## [谷歌编程之夏](https://www.freebsd.org/status/report-2009-10-2009-12.html#Google-Summer-of-Code)
...
### [Clang 替代 GCC 作为基本系统编译程序](https://www.freebsd.org/status/report-2009-10-2009-12.html#Clang-replacing-GCC-in-the-base-system)
...
2. 在 AP 模式下读取 TX 统计信息，或确认哪些芯片组支持 AP 模式，如果并非所有芯片组都支持。
3. 维护代码。
...
- 环境与支持工具：
  - 将设备树编译程序（dtc）和 libfdt 集成到 FreeBSD 用户空间、内核和加载器构建中。
  - loader(8)：
    - 完整支持设备树 Blob 处理。
