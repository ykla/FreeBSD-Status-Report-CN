...
联系方式：Dawid Górecki <[dgr@semihalf.com](mailto:dgr@semihalf.com)>
...
联系方式：在 `irc.libera.chat` 的 `#helloSystem`，在 [Matrix](https://matrix.to/#/%23helloSystem:matrix.org?via=matrix.org) 镜像为 [`#helloSystem:matrix.org`](https://matrix.to/#/%23helloSystem:matrix.org?via=matrix.org)
