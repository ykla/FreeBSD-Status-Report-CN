...
联系方式：Simran Kathpalia <[skathpalia3@gmail.com](mailto:skathpalia3@gmail.com)>
...
联系方式：Neel Chauhan <[nc@FreeBSD.org](mailto:nc@FreeBSD.org)>
...
联系方式：Lukasz Hajec <[lha@semihalf.com](mailto:lha@semihalf.com)>
...
联系方式：Wojciech Kloska <[wojciech@conclusive.pl](mailto:wojciech@conclusive.pl)>
...
联系方式：Paweł Eichler <[pawel@conclusive.pl](mailto:pawel@conclusive.pl)>
...
联系方式：在 `irc.libera.chat` 上的 `#helloSystem`，镜像到 [Matrix 上的 `#helloSystem:matrix.org`](https://matrix.to/#/%23helloSystem:matrix.org?via=matrix.org)
