...
[基金会新闻和事件](https://www.freebsdfoundation.org/news-and-events/)
...
联系方式：Damjan Jovanovic <[damjan.jov@gmail.com](mailto:damjan.jov@gmail.com)>
...
联系方式：在 `irc.libera.chat` 的 `#helloSystem`，也可以在 [Matrix](https://matrix.to/#/%23helloSystem:matrix.org?via=matrix.org) 上找到 [#helloSystem:matrix.org](https://matrix.to/#/%23helloSystem:matrix.org?via=matrix.org)
