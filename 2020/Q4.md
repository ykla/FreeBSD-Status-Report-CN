...
在上个季度，新增虚拟类别：`education`，适用于帮助用户学习某一主题和辅助考试的 ports。
...
- 最大的新闻是，得益于 FreeBSD 基金会（以及 Philip Paeps 的协助），FreeBSD 现在拥有两台新的 aarch64 机器，替代了之前那些老化严重的机器。从 8 月以来，我们首次再次拥有了最新的 aarch64 包。
