...
我们希望您在阅读时能像我们编写报告时一样享受其中。
Daniel Ebdrup Jensen，代表季度团队。


## [FreeBSD 团队报告](https://www.freebsd.org/status/report-2020-10-2020-12.html#FreeBSD-Team-Reports)

来自各种官方和半官方团队的条目，您可以在[管理页面](https://www.freebsd.org/administration.html)找到。

### [FreeBSD 基金会](https://www.freebsd.org/status/report-2020-10-2020-12.html#FreeBSD-Foundation)

联系人：Deb Goodkin <[deb@FreeBSDFoundation.org](mailto:deb@FreeBSDFoundation.org)>

FreeBSD 基金会是一家 501(c)(3) 非营利组织，致力于支持和促进全球 FreeBSD 项目和社区。基金会的资金来自个人和企业捐赠，主要用于资助和管理软件开发项目、会议和开发者峰会，并为 FreeBSD 贡献者提供旅行资助。基金会还购买和支持硬件，以改善和维护 FreeBSD 基础设施，提供资源以改善安全性、质量保证和发布工程工作；发布营销材料以推广、教育和倡导 FreeBSD 项目；促进商业供应商与 FreeBSD 开发者之间的合作；并代表 FreeBSD 项目执行合同、许可协议及其他需要合法实体的法律安排。
...
我们想借此机会感谢去年所有捐款帮助我们筹集资金的个人和公司。截至撰写本文时，我们筹集了 1,235,926 美元，最终的筹款总额将在 1 月中旬确定。为我们提供慷慨捐款的公司包括 Arm、NetApp、Netflix、Juniper Networks、Beckhoff、VMware、Stormshield、Tarsnap 和 Google。我们还要感谢 Koum 家族基金会为我们颁发的大额资助，以及 Nginx 员工的慷慨捐款。

我们真正感激这些大额捐款，它们对我们能为项目做出多少贡献产生了最大影响。然而，最令我们感动的还是个人捐款。那些捐款的人信任我们会将他们的个人捐款（无论大小）投资于改善操作系统和项目。作为您捐款的管理者，我们要感谢您对我们的信任，并感谢您对将 FreeBSD 打造成最佳平台的承诺，这个平台涵盖产品、教育、研究、计算等多个领域。

您将在本报告中了解我们如何使用您的捐款进行第四季度工作，并通过本报告中的单独报告了解更多信息。
...
我们还设有合作伙伴计划，为我们的较大商业捐助者提供更多福利。了解更多信息，请访问 [https://www.FreeBSDfoundation.org/FreeBSD-foundation-partnership-program/](https://www.freebsdfoundation.org/FreeBSD-foundation-partnership-program/) 并与您的公司分享！

#### 改进操作系统

在过去的一个季度中，基金会提供了许多项目资助，您可以在本报告的其他条目中阅读有关 OpenZFS Zstd 支持、Linuxulator 应用程序兼容性改进、LLDB 目标支持、测试实验室基础设施和 WiFi 项目的相关内容。
...
员工们回应了报告的安全漏洞和发布 errata，准备了补丁，并参与了安全建议过程。我们还致力于前瞻性的安全漏洞缓解工作。Syzkaller 也提供了许多内核问题报告，这些报告促使基金会资助了 bug 修复。我们还解决了多个与 FreeBSD/arm64 相关的问题，推动其朝着 Tier-1 架构的发展方向迈进。
...
基金会提供了一名全职员工，并资助项目，旨在改善 FreeBSD 项目的持续集成、自动化测试以及整体质量保证工作。
...
您可以在 [https://www.FreeBSDfoundation.org/news-and-events/](https://www.freebsdfoundation.org/news-and-events/) 查找我们参加的活动和即将举行的活动。
...
您可以在 [FreeBSD Wiki](https://wiki.freebsd.org/OfficeHours) 上找到未来办公时间的安排以及过去办公时间的视频。
...
Linux 兼容层改进工作已经进行两年，得到了 FreeBSD 基金会的资助，涵盖了几个不同的项目资助，以及社区的贡献。该项目的目标是提升 FreeBSD 执行未修改 Linux 二进制文件的能力。目前的进展可在 [Linux 应用状态 Wiki 页面](https://wiki.freebsd.org/LinuxApps) 上追踪。工作现已从命令行应用转向桌面应用。

在本季度，除了扩展 fuse(4)，使其能够运行 Linux FUSE 服务器（这是运行 AppImages 所必需的事项之一），FreeBSD 基金会资助的工作不多。基金会资助的工作将持续到 2021 年第一季度，确保 13.0-RELEASE 版本中 Linuxulator 以良好状态发布。
...
*Fenestras X* 实现已在 `CURRENT` 中提供，但默认情况下是禁用的。（默认实现仍为 *Fortuna*。）目前，您必须在自定义内核配置中设置 `RANDOM_FENESTRASX` 选项，并重新构建内核以使用新设计。目前没有已知的 bug 或相对于 *Fortuna* 实现的弱点。
...
这项将 ZSTD 完全集成到 ZFS 中的工作由 FreeBSD 基金会资助。
...
我们感谢所有贡献者，无论是翻译还是审阅文档。同时，请帮助在您的本地用户组中推广这项工作，我们总是需要更多志愿者。
...
您可以找到 [正在更新 FreeBSD 文档项目简介为 Hugo/AsciiDoctor 的工作进展](https://github.com/sergio-carlavilla/documentation-project-primer)。
...
| 链接 |
| --- |
| [ESXi-ARM Fling](https://flings.vmware.com/esxi-arm-edition "https://flings.vmware.com/esxi-arm-edition") |
| [FreeBSD 在 VMWare ESXi-ARM Fling 下运行](https://vincerants.com/freebsd-under-vmware-esxi-on-arm-fling/ "https://vincerants.com/freebsd-under-vmware-esxi-on-arm-fling/") |
| [FreeBSD 在 ESXi-ARM Fling 下：修复虚拟硬件](https://vincerants.com/freebsd-on-esxi-arm-fling-fixing-virtual-hardware/ "https://vincerants.com/freebsd-on-esxi-arm-fling-fixing-virtual-hardware/") |
| [FreeBSD 上的 open-vm-tools 在 VMWare ESXi-ARM Fling 下](https://vincerants.com/open-vm-tools-on-freebsd-under-vmware-esxi-arm-fling/ "https://vincerants.com/open-vm-tools-on-freebsd-under-vmware-esxi-arm-fling/") |
...
Bastille 模板自动化容器设置，允许您根据需要轻松复制容器。
...
| 链接 |
| --- |
| [CHERI 项目主页](http://www.cheri-cpu.org/ "http://www.cheri-cpu.org") |
| [CheriBSD GitHub 仓库](https://github.com/CTSRD-CHERI/cheribsd "https://github.com/CTSRD-CHERI/cheribsd") |
| [Morello 平台登陆页](https://www.morello-project.org/ "https://www.morello-project.org") |
| [CheriBSD Morello 开发者预览](https://morello-dist.cl.cam.ac.uk/ "https://morello-dist.cl.cam.ac.uk") |
| [Arm Morello 项目](https://developer.arm.com/architectures/cpu-architecture/a-profile/morello "https://developer.arm.com/architectures/cpu-architecture/a-profile/morello") |
...
| 链接 |
| --- |
| [FreeBSD 嵌入式实验室设计](https://www.funkthat.com/gitea/jmg/fbsdembdev "https://www.funkthat.com/gitea/jmg/fbsdembdev") |
| [实验室 API 代码](https://www.funkthat.com/gitea/jmg/bitelab "https://www.funkthat.com/gitea/jmg/bitelab") |
...
| 链接 |
| --- |
| [FreshPorts](http://freshports.org/ "http://freshports.org/") |
| [FreshPorts 博客](http://news.freshports.org/ "http://news.freshports.org/") |

联系方式：Dan Langille <[dan@langille.org](mailto:dan@langille.org)>

FreshPorts 及其姊妹网站 FreshSource 已经报道 FreeBSD 提交了 20 年。它们涵盖了所有提交，而不仅仅是 Port 。
...
| 链接 |
| --- |
| [文档](https://hellosystem.github.io/docs/ "https://hellosystem.github.io/docs/") |
...
| 链接 |
| --- |
| [K8S-bhyve](https://k8s-bhyve.convectix.com/ "https://k8s-bhyve.convectix.com") |
| [K8S-bhyve](https://github.com/k8s-bhyve "https://github.com/k8s-bhyve") |
...
在 2020Q4，我们制作并发布了 k8s-bhyve 镜像，您可以通过 [ISO/memstick](https://k8s-bhyve.convectix.com/kbhyve-latest.iso) 进行安装，也可以通过 [bsdinstall](http://k8s.bsdstore.ru/auto) 进行安装。
...
| [Puppet 的 FreeBSD Slack 渠道](https://puppetcommunity.slack.com/messages/C6CK0UGB1/ "https://puppetcommunity.slack.com/messages/C6CK0UGB1/") |
| [Bolt](https://puppet.com/docs/bolt/latest/bolt.html "https://puppet.com/docs/bolt/latest/bolt.html") |
| [Choria](https://choria.io/ "https://choria.io/") |
