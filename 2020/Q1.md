...
2019 年 10 月 18 日，Arm 宣布了 Morello，一款实验性的 CHERI 扩展、多核、超标量的 ARMv8-A 处理器、系统芯片（SoC）以及原型板，预计将在 2021 年底推出。Morello 是英国数字安全设计挑战（DSbD）计划的一部分，该计划获得了英国工业战略挑战基金（UKRI）的支持，其中包括 Arm 对该计划的超过 5000 万英镑的承诺。该计划旨在大规模测试和验证 CHERI 扩展到 ARM ISA 的效果，“成功的概念预计将进入架构中。”Morello 板计划于 2021 年第三季度发货。
