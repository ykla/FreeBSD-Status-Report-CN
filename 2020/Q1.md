...
2007 年，GNU 编译程序集合（GCC）迁移到 GPLv3，这引发了关于 FreeBSD 工具链未来的讨论。我们在 BSDCan 2010 举行了 [工具链峰会](https://wiki.freebsd.org/201005ToolchainSummit)。Roman Divacky 在会上更新了 ClangBSD 项目的进展，展示了使用新并快速发展的 Clang 编译程序构建 FreeBSD 的情况。
