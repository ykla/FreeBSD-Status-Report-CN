...
有超过一半的预算直接用于改进 FreeBSD，并确保其安全性。若存在安全漏洞，我们的软件开发人员可迅速介入，评估情况，并在需要时进行更改或采用变通方案。我们有一名全职开发人员主导持续集成工作，并研究改进测试代码的工具、提高测试覆盖率以及帮助开发人员提高效率的方式。我们还把更多资金用于宣传工作。比如编写一些东西来展现 FreeBSD 的优势和特长，采访商业用户并记录其用例，推广社区所做的工作。
