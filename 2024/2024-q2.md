...
- 长期合同聘用的 [Olivier Certner](mailto:olce@FreeBSD.org) 活跃在源代码的各方面：
  ...
  - vnode 回收与 ZFS ARC 回收：审查了 [bug #275594](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=275594) 的修复，联系了上游以获取和测试反向移植补丁，发布了勘误通知并将其应用为 13.3-RELEASE-p2。开始了一项长期工作，以改进 Vnode 回收机制，并让 ZFS 传递正确信息。
