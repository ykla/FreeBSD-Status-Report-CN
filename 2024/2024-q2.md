...
- [Christos Margiolis](mailto:christos@FreeBSD.org) 继续改进 FreeBSD 的音频栈，并为音频开发者提供有用的工具和框架，以促进在 FreeBSD 上的音频开发。详情请参阅条目[音频栈改进](https://www.freebsd.org/status/report-2024-04-2024-06/#_audio_stack_improvements)。
...
- 长期合同聘用的[Olivier Certner](mailto:olce@FreeBSD.org) 活跃在源代码的不同部分中：
...
- [Pierre Pronchery](mailto:pierre@freebsdfoundation.org) 继续与基金会合作开展进行一项以安全为中心的项目，其中包括：
  ...
  - 基于 bhyve 运行 Coverity 扫描报告来协助改正报告发现的问题
