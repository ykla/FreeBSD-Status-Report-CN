...
联系方式：Microsoft FreeBSD 集成服务团队（[bsdic@microsoft.com](mailto:bsdic@microsoft.com)）

联系方式：[freebsd-cloud 邮件列表](https://lists.freebsd.org/subscription/freebsd-cloud)
...
Free Pascal 是一款成熟的、功能强大的开源 Pascal 编译程序，支持多种操作系统和处理器架构：Intel x86（16 位和 32 位）、AMD64/x86-64、PowerPC、PowerPC64、SPARC、SPARC64、ARM、AArch64、MIPS、摩托罗拉 68k、AVR 和 JVM。此外，开发版还支持 RISC-V（32/64 位）、Xtensa 和 Z80 架构，并支持 LLVM 编译程序基础设施。同时，Free Pascal 团队还维护着一款名为 pas2js 的 Pascal 到 JavaScript 的转换器。
