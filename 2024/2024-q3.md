...
不幸的是，同上个季度一样，本季度我们再次迟到。正如许多读者所知，FreeBSD 的许多贡献者都是志愿者，因此像状态报告这类截止日期优先级较低的工作，并不总能按时完成。事实上，如果你还不是 FreeBSD 的贡献者，[请考虑加入我们](https://docs.freebsd.org/en/articles/contributing/)：你可在与世界各地的开发者一道工作的同时，减轻大家的负担，同时学到新技能。
