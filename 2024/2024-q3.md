...
[FreeBSD Foundation 的 Ed Maste](mailto:emaste@FreeBSDFoundation.org) 对在 Bugzilla 上增加更多有用的图表表示了兴趣。我们目前拥有的图表信息量有限。尽管已记录了许多 [有趣的 Bugzilla 查询](https://wiki.freebsd.org/Bugzilla/SearchQueries)，但其中的信息较为密集。
