...
核心团队于 2024 年 12 月 12 日与 FreeBSD 基金会进行了视频会议，跟进之前在 EuroBSDCon 期间于都柏林举行的线下会议。核心团队继续与基金会探讨如何加强合作，来支持开发者和贡献者：
...
我是 Deb Goodkin，代表基金会，首先要感谢这个了不起的社区！正是由于大家的财务支持，我们才能开展一些重要项目，包括大规模、多阶段的软件开发工作、更深入的安全改进，并将持续至 2025 年的重要基础设施改进。此外，我们还加大了 FreeBSD 的推广力度，涉及了多个技术和社交媒体平台，并制作了更多内容来宣传和推广 FreeBSD。更多相关信息，请见下文。如果想深入了解我们在 2024 年的工作，请查看年底博客文章以及我在推广部分的年度回顾。
...
我们对 2025 年及 FreeBSD 日后的发展机遇感到兴奋，我们正在扩展团队，以支持抓住这些机遇所需的工作。然而，我们需要你的帮助来维持这一切。我们的投资最多只能支撑一到两年。如果你的公司关注 FreeBSD 的长期可持续发展，请考虑提供资金支持，确保 FreeBSD 继续成为你所依赖的安全、可靠和创新的平台。不知道如何提出申请？请联系我们，我们可以帮助你完成流程。
...
- [由 Sovereign Tech Agency 资助的 FreeBSD 基础设施现代化项目](https://www.freebsd.org/status/report-2024-10-2024-12/#_infrastructure_modernization) 在本季度继续推进。此项目的目标是实现并维持可管理的 bug 积压水平。基金会与 [Bitergia](https://bitergia.com/) 合作，对 Bugzilla 上的未解决 bug 进行分析和评估。[Muhammad Moinur Rahman](mailto:bofh@FreeBSD.org) 完成了 Grimoirelab 的移植，并在 FreeBSD 集群中部署了 [Grimoire](https://grimoire.freebsd.org/)。
...
- [Isaac Freund](mailto:ifreund@freebsdfoundation.org) 完成了 [受 PkgBase 推动的 pkg 改进](https://www.freebsd.org/status/report-2024-10-2024-12/#_pkgbase_motivated_improvements_to_pkg)。
...
基金会持有 FreeBSD 商标，负责保护这些商标。同时，我们还为核心团队提供法律支持，以调查和解决出现的相关问题。
...
本季度，该团队管理了 14.2-RELEASE 的发布流程，最终于 12 月完成了官方 RELEASE 版本的构建和发布。目前，团队已开始规划即将推出的 13.5-RELEASE 版本，该版本预计将是旧版 **stable/13** 分支的最终版本。因此，它将包含 contrib 代码的更新和一些漏洞修复，但不太可能引入重大新功能。
...
AppJail 及其所有元项目广泛遵循 [The Ephemeral Concept](https://man.freebsd.org/cgi/man.cgi?query=appjail-ephemeral&apropos=0&sektion=0&manpath=FreeBSD+14.2-RELEASE+and+Ports&arch=default&format=html)，该概念有助于使 Jail 更新/升级变得更加容易，因为它们变得可以丢弃。自从该概念在 AppJail 中实现以来，我一直在广泛使用它来部署我的 Jail 服务。
