...
在 2024 年第四季度，共有 382 个 `src`、135 个 `ports` 和 17 个 `doc` 提交将 FreeBSD 基金会标注为赞助方。

基金会及其投资合作伙伴支持了四个主要项目：

- [Konstantin Belousov](mailto:kib@FreeBSD.org) 继续开发 FreeBSD 上的 AMD IOMMU 驱动程序，该项目由 AMD 和基金会共同资助。此项工作旨在增强对大核心数 AMD 系统以及其他需要中断重映射的场景的支持。该驱动程序已于 11 月初 [推送至 src 树](https://cgit.freebsd.org/src/commit/?id=0f5116d7efe33c81f0b24b56eec78af37898f500)，并持续进行着测试和优化。
