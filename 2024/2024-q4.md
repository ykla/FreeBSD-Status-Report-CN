...
- 原文：[FreeBSD Status Report Fourth Quarter 2024](https://www.freebsd.org/status/report-2024-10-2024-12/)
- 版本：2025 年 2 月 28 日
- 最后作者：Lorenzo Salvadore

## 引言

以下是 2024 年的第四份也是最后一份状态报告，共包含 44 项条目。

这表明：2024 年是成果丰硕又繁忙的一年。通常来说，年末几个月的工作节奏会有所放缓，因为人们会去度假，庆祝新年。但我们依然在许多方面取得了巨大进展，交付了诸多成果！

整理和编写这份报告花费的时间比预期更长，但等待是值得的。

感谢整个社区的卓越工作，特别感谢那些为本报告提供更新内容的贡献者！
...
核心团队于 2024 年 12 月 12 日与 FreeBSD 基金会进行了视频会议，跟进之前在 EuroBSDCon 期间于都柏林举行的线下会议。核心团队继续与基金会探讨如何加强合作，以及如何支持开发者和贡献者：
...
FreeBSD 基金会是一家 501(c)(3) 非营利组织，致力于通过技术和非技术支持推动 FreeBSD 的发展。基金会完全由捐赠资助，支持软件开发、基础设施、安全及协作工作；组织活动和开发者峰会；提供教育资源；并在法律事务中代表 FreeBSD 项目。本报告仅介绍了 2024 年第四季度基金会支持 FreeBSD 的一部分工作。

我是 Deb Goodkin，代表基金会，首先要感谢这个了不起的社区！正是由于你的财务贡献，我们才能加大力度，承担一些重要项目，包括大规模、多阶段的软件开发工作、更大规模的安全改进，以及将持续至 2025 年的重要基础设施改进。此外，我们还加大了 FreeBSD 的推广力度，涉及了多个技术和社交媒体平台，并制作了更多内容来宣传和推广 FreeBSD。更多相关信息，请见下文。如果想深入了解我们在 2024 年的工作，请查看年底博客文章以及我在推广部分的年度回顾。
...
我们仍在确认 2024 年筹款的最终数字，截至目前，我们已筹集约 $1,324,000。你可能会想：既然已经是 2025 年了，为何还没有最终统计数据？首先，我们尚未收到所有邮戳日期为 2024 年的支票。其次，我们也在等待去年开具发票的几笔款项。我们将在下一季度的状态报告中公布最终报告。
...
此外，我要特别感谢一位匿名捐赠者，他希望我们帮助开发者获得 Framework 笔记本电脑。Pietro Cerutti 一直在协调这项工作，目前我们已几乎与 Framework 公司敲定了流程，以便开发者能够直接向他们下单。

我们还为 BSDCon AV 团队资助了近 $5,000 的音视频设备，以减少两次主要 BSD 会议每次所需租赁的设备数量。
...
我们对 2025 年及 FreeBSD 日后的发展机遇感到兴奋，我们正在扩展团队，以支持抓住这些机遇所需的工作。然而，我们需要你的帮助来维持这一切。我们的投资最多只能支撑一到两年。如果你的公司致力于 FreeBSD 的长期可持续发展，请考虑提供资金支持，确保 FreeBSD 继续成为你所依赖的安全、可靠和创新的平台。不知道如何开口？请联系我们，我们可以帮助你完成流程。
...
在 2024 年第四季度，我们继续提高 FreeBSD 的知名度，宣传 FreeBSD 项目，展示用户故事，并为 FreeBSD 社区提供教育信息。以下是一些重要工作概述：
...
- 分享了 [FreeBSD 基金会 2024 年对 Capsicum 和 bhyve 子系统的安全审计报告](https://freebsdfoundation.org/wp-content/uploads/2024/11/2024_Code_Audit_Capsicum_Bhyve_FreeBSD_Foundation.pdf)，详见安全审计报告条目。
...
在 2024 年第四季度，共有 382 个 `src`、135 个 `ports` 和 17 个 `doc` 提交标注 FreeBSD 基金会为赞助商。

基金会及其投资合作伙伴支持了四个主要项目：

- [Konstantin Belousov](mailto:kib@FreeBSD.org) 继续开发 FreeBSD 上的 AMD IOMMU 驱动程序，该项目由 AMD 和基金会共同资助。此项工作旨在增强对大核数 AMD 系统以及其他需要中断重映射的场景的支持。该驱动程序已于 11 月初 [推送至 src 树](https://cgit.freebsd.org/src/commit/?id=0f5116d7efe33c81f0b24b56eec78af37898f500)，并持续测试和优化。
...
- [由 Sovereign Tech Agency 资助的 FreeBSD 基础设施现代化项目](https://www.freebsd.org/status/report-2024-10-2024-12/#_infrastructure_modernization) 在本季度继续推进。此项目的目标是帮助实现并维持可管理的 bug 积压水平。作为此项工作的一部分，基金会与 [Bitergia](https://bitergia.com/) 合作，对 Bugzilla 上的未解决 bug 进行分析和评估。[Muhammad Moinur Rahman](mailto:bofh@FreeBSD.org) 完成了 Grimoirelab 的移植，并在 FreeBSD 集群中部署了 [Grimoire](https://grimoire.freebsd.org/)。
...
- [Aymeric Wibo](mailto:obiwac@FreeBSD.org) 开始实现 [suspend-to-idle 和 S0ix 睡眠支持](https://www.freebsd.org/status/report-2024-10-2024-12/#_suspendresume_improvements)。
...
- [Isaac Freund](mailto:ifreund@freebsdfoundation.org) 致力于 [受 pkgbase 推动的 pkg 改进](https://www.freebsd.org/status/report-2024-10-2024-12/#_pkgbase_motivated_improvements_to_pkg)。
...
- [Joseph Mingrone](mailto:jrm@FreeBSD.org) 花时间在个人项目上 [改进 Ports 中的 Common Lisp 支持](https://www.freebsd.org/status/report-2024-10-2024-12/#_improving_common_lisp_infrastructure_in_freebsd_ports)。
...
基金会的其他开发团队成员也为 FreeBSD 做出了贡献，例如：
...
作为我们对 FreeBSD 项目的持续支持的一部分，基金会安排了一名全职工作人员，专门负责 [改进项目的持续集成系统和测试基础设施](https://www.freebsd.org/status/report-2024-10-2024-12/#_ci)。

#### 法务与 FreeBSD 知识产权

基金会持有 FreeBSD 商标，负责保护这些商标。同时，我们还为核心团队提供法律支持，以调查出现的问题。
...
[FreeBSD 14.2-RELEASE 公告](https://www.freebsd.org/releases/14.2R/announce/)

[FreeBSD 13.5-RELEASE 计划](https://www.freebsd.org/releases/13.5R/schedule/)

[FreeBSD RELEASE 版本](https://download.freebsd.org/releases/ISO-IMAGES/)
...
本季度，该团队管理了 14.2-RELEASE 的发布流程，最终于 12 月完成了官方 RELEASE 版本的构建和发布。目前，团队已开始规划即将推出的 13.5-RELEASE 版本，该版本预计将是旧版 **stable/13** 分支的最终版本。因此，它将包含 contrib 代码的更新和一些缺陷修复，但不太可能引入重大新功能。

除了以往发布的 ISO 和 U 盘镜像、VM 镜像、云端映像等，团队现在还提供了兼容 OCI（开放容器倡议）的容器镜像。
...
FreeBSD 集群管理团队负责管理项目所依赖的计算机，用于镜像、同步工作和通信。
...
除软件包构建服务器和面向开发者的 `dogfood` 机器外（**译者注：dogfood 是俚语，意为“自用自测”，即自己使用自己开发的产品**），FreeBSD 集群大多运行 stable/X 分支。
...
集群中的 297 个 Jail 中，已有 222 个运行在 stable/14。
...
我们始终欢迎新增官方镜像站。实践证明，在互联网交换点（IXP）托管镜像站在全球范围内非常有益，例如我们在澳大利亚、巴西和南非的现有镜像站。如果你所属或了解任何愿意赞助单独镜像服务器的机构，请联系我们。我们尤为希望在美国西海岸和欧洲各地拓展新的镜像站。
...
[参与 Ports](https://docs.freebsd.org/en/articles/contributing/#ports-contributing)
...
在上个季度，Ports 管理团队进行了 14 次实验性构建（exp-run），以测试各类 Ports 升级及对 `bsd.port.mk` 的改动。

### Bugmeister 团队

**链接**：

[FreeBSD Bugzilla](https://wiki.freebsd.org/Bugzilla)
...
整体 PR 数量从 11,600+ 降至 11,000，这得益于多位成员的努力，他们整理了整个 PR 组（见下文）。

Mark Linimon 多次参与了与 src 提交者的视频会议。目前，他们正在进行一些实验，以了解哪些工作流程是可持续的。最近的一项工作是审阅最新提交的 src PR，你会注意到，过去几周的许多 PR 都被标记为请求反馈。

此外，Bugmeister 团队清理了 Bugzilla 数据库的元数据，具体包括：

- 重新分配 Bug，避免将其指派给提交权限已被保留（safekept）的一年期内未活跃的开发者。
- 清理基本系统（base）的 `In Progress`（处理中）状态 Bug，其中许多未被积极处理，目前数量降至 184。
  ...
  - 目前，我们将 `In Progress` 仅保留给真正处于开发状态的 Bug，数量已从过多降至仅剩少数。
...
我们欢迎 Lexi（Discord ID: ivy）加入 Triage（分类）团队。
...
**联系方式**：src 管理团队 <[srcmgr@FreeBSD.org](mailto:srcmgr@FreeBSD.org)>

已由核心团队批准成立一个新的 [源代码管理团队](https://www.freebsd.org/administration/#t-srcmgr)，负责管理 FreeBSD 源代码，类似于 Ports 管理团队和文档工程团队分别负责管理 Ports 和文档。初始团队成员包括 Ed Maste、Mark Johnston、John Baldwin 和 Warner Losh。src 管理团队目前的重点是寻找提高源代码开发者工作效率的方法，并尝试管理大量的 bug 报告和拉取请求（PR）。团队每两周举行一次会议，讨论与源代码相关的问题，并花时间处理 bug 报告和拉取请求。可在 GitHub 上查看 [会议纪要](https://github.com/freebsd/meetings/tree/master/srcmgr)。src 管理团队有 [章程](https://www.freebsd.org/srcmgr/charter/)，并正在开发和记录帮助管理源代码树的政策。

在 2024 年 12 月，源代码管理团队举办了一次在线 bug 修复活动，共有 15 名开发者参与。我们花时间回顾了最近的 bug 报告，以及带有补丁的旧报告。团队计划每月举办此类活动，并希望后续向更广泛的参与者开放。

团队计划在 2025 年上半年开发一个类似于 Ports 管理团队的见习者计划。

## 项目

涉及多个类别的项目，从内核和用户空间到 Ports 和第三方项目。
...
该项目始于 2024 年第三季度，由 Sovereign Tech Agency 委托，预算为 745,000 美元，计划在大约一年内完成。主要目标是提升基本系统、Ports 和软件包的安全工具，更新项目的基础设施以加速开发，增强构建安全性，并简化新开发者的入门过程。

第四季度更新：

- 工作包 A：偿还技术债务。基金会与源代码管理团队合作，定制并部署了多个仪表板，用于概览 FreeBSD 项目的 bug 积压情况。这些仪表板由我们的项目合作伙伴 Bitergia 使用开源工具 GrimoireLab 创建，并按照团队的规格设计。基金会工作人员将这些仪表板托管在 FreeBSD 部署上，访问地址为 [https://grimoire.freebsd.org/](https://grimoire.freebsd.org/)。可以在 [https://github.com/freebsd/grimoire](https://github.com/freebsd/grimoire) 上找到更多有关仪表板的信息。
  src 管理团队还使用这些仪表板支持他们处理 bug 报告的新方法，这些仪表板已成为协作修复 bug 活动的关键工具。
- 工作包 B：零信任构建，工作包 C：CI/CD 自动化。基金会与 FreeBSD 项目内的各个关键行政和管理团队合作，共同界定了这两个项目的范围。计划于 1 月开始，并将在第二、三季度结束。
- 工作包 D：Ports 和软件包中的安全控制，工作包 E：改进软件物料清单（SBOM）。这两个项目尚未开始，分别计划在 2 月和 3 月启动。

委托机构：[Sovereign Tech Agency](https://www.sovereign.tech/)
...
该项目始于 2024 年第四季度，受 FreeBSD 基金会和 Quantum Leap Research 资助。项目预算为 750,000 美元，计划在一到两年内完成。项目的目标是改善 WiFi、音频可用性、挂起和恢复功能、图形和蓝牙等关键功能。团队还将创建清晰的文档和逐步指南，帮助用户使用新功能。

第四季度更新：

- 基金会 [启动了该项目](https://freebsdfoundation.org/blog/why-laptop-support-why-now-freebsds-strategic-move-toward-broader-adoption/)，创建了 [公开路线图](https://github.com/FreeBSDFoundation/proj-laptop)，并将承包商分配到相关工作流。12 月是首次开发迭代，覆盖以下内容：
...
**赞助者**：[Quantum Leap Research](https://www.ql-research.com/)

### FreeBSD 基金会的安全工程

**链接**：

[FreeBSD 基金会发布由 Alpha-Omega 项目资助的 bhyve 和 Capsicum 安全审计](https://freebsdfoundation.org/news-and-events/latest-news/freebsd-foundation-releases-bhyve-and-capsicum-security-audit-funded-by-alpha-omega-project/)

[FreeBSD 安全审计如何改善我们的安全文化](https://fosdem.org/2025/schedule/event/fosdem-2025-6152-how-freebsd-security-audits-have-improved-our-security-culture/)

[ORC WG 的主页](https://github.com/orcwg/orcwg)

[FreeBSD 基金会：联系我们](https://freebsdfoundation.org/about-us/contact-us/)

[开源漏洞架构 (OSV Schema)](https://openssf.org/projects/osv-schema/)

[ossf/osv-schema 工具：导入 VuXML 转换工具](https://github.com/ossf/osv-schema/pull/237)

**联系方式**：Pierre Pronchery <[pierre@freebsdfoundation.org](mailto:pierre@freebsdfoundation.org)>

我在 FreeBSD 基金会的任务继续围绕 FreeBSD 项目的安全工程工作。

首先，我们继续处理 bhyve 和 Capsicum 的源代码审计结果，记录并研究如何防范类似问题再次发生并减轻其影响。这包括与 FreeBSD 项目贡献相关的过程，以及与 Alpha-Omega 在即将到来的 2025 年 FOSDEM 大会期间，在 BSD Devroom 举行联合演讲的准备工作。

与此同时，我与开放监管合规工作组（ORC WG）保持联系，多个利益相关方正在共同编写有关欧盟新引入的《网络弹性法案》（CRA）的常见问题解答。这与我们同 OpenSSF 的持续合作有关，特别是自我评估计划；请注意，FreeBSD 基金会可以为部署 FreeBSD 的项目提供相关协助。

最后，我们正在研究将 OSV 工具集成到 FreeBSD 生态系统中的可能性。
...
信息通过一份在线详尽调查收集，调查围绕现有的安全性分析框架进行。各团队被要求描述当前的开发流程并评估现有的安全实践，同时提出改进建议。
...
**赞助者**：[Alpha Omega 项目](https://alpha-omega.dev/)
...
[跟踪问题：Framework 笔记本：功能支持、错误和改进](https://bugs.freebsd.org/262152)
...
长期以来，Framework 在许多方面对 FreeBSD 项目表现出友好态度，包括为基金会提供工程样品以供测试并支持工作。
...
来自 Framework Computer Inc 的 Daniel 在 [Framework Computer 的 GitHub 组织下创建了一个仓库](https://github.com/FrameworkComputer/freebsd-on-framework)，以记录安装笔记和其他信息。他修复了指纹识别器（libfprint），不仅仅是为 Framework 提供支持，而是为 FreeBSD 提供通用支持。他还在为 FreeBSD 的许多相关驱动程序提供支持和修复。

在 11 月，基金会人员和一些 FreeBSD 开发者访问了 Framework 的旧金山办公室，召开会议检查当前的 FreeBSD 支持状态，并讨论未来的合作计划。

基金会将继续致力于改善通用的笔记本支持，并将 Framework 作为 [目标平台之一](https://github.com/FreeBSDFoundation/proj-laptop/blob/main/supported/laptops.md) 用于 [笔记本支持和可用性项目](https://github.com/FreeBSDFoundation/proj-laptop/)。

**赞助者**：FreeBSD 基金会（支持許立文的工作）

**赞助者**：Framework Computer Inc（支持 Daniel 的工作、硬件和空间支持）
...
通过 [pkg-create(8)](https://man.freebsd.org/cgi/man.cgi?query=pkg-create&sektion=8&format=html) 创建软件包时，pkg 会扫描包含的文件，并根据找到的可执行文件/共享库生成 shlibs_provided/shlibs_required 列表。在我的更改之前，pkg 会使用主机系统的 elf 提示文件作为 pkg-create 的输入，以便从生成的 shlibs_required 列表中过滤掉由基本系统提供的共享库。选项 ALLOW_BASE_SHLIBS 会禁用此过滤，以便构建 pkgbase 软件包。

在我的修改之后，pkg-create 不再读取主机系统的 elf 提示文件，基本系统的共享库会包含在生成的 shlibs_required 列表中。当 [pkg-install(8)](https://man.freebsd.org/cgi/man.cgi?query=pkg-install&sektion=8&format=html)/[pkg-upgrade(8)](https://man.freebsd.org/cgi/man.cgi?query=pkg-upgrade&sektion=8&format=html)/等调用求解器时，在非 pkgbase 系统上，pkg 会通过扫描 `/lib` 和 `/usr/lib` 来生成基本系统提供的共享库列表，并将其作为求解器的输入。在 pkgbase 系统上，pkgbase 软件包提供所有基本系统的共享库。

这使得选项 `ALLOW_BASE_SHLIBS` 不再需要。它还改进了 Port 软件包与 pkgbase 软件包之间的集成，因为现在跟踪了 Port 软件包对 pkgbase 软件包的共享库依赖，而不是忽略这些依赖。最后，这一变化显著简化了 pkg 的代码库并提高了可移植性。此修改已在 [https://github.com/freebsd/pkg/pull/2386](https://github.com/freebsd/pkg/pull/2386) 中实现，但尚未包含在 pkg 发布版本中。
...
[改善 FreeBSD 安装程序的修复能力](https://wiki.freebsd.org/SummerOfCode2024Projects/ImprovingRepairAbilityOfTheFreeBSDInstaller)

[编程之夏 2024 - 改进带修复和升级能力的安装程序 (#1395)](https://github.com/freebsd/freebsd-src/pull/1395)

[bsdinstall: 在实时环境中添加 pkg 安装支持 (#1424)](https://github.com/freebsd/freebsd-src/pull/1424)

[bsdinstall: 向安装程序菜单添加修复脚本 (#1427)](https://github.com/freebsd/freebsd-src/pull/1427)

[笔记本电脑和桌面工作组](https://wiki.freebsd.org/LaptopDesktopWorkingGroup)

**联系方式**：Pierre Pronchery <[pierre@freebsdfoundation.org](mailto:pierre@freebsdfoundation.org)>

作为 2024 年编程之夏项目的一部分，我有幸指导葉君政（化名“Leaf”）实现了一些额外功能。目标是增加对修复或更新现有 FreeBSD 安装的支持，同时允许在实时环境中安装软件包。这项工作已经整合为三个不同的 PR，托管在 GitHub 上。尽管某些方面可能仍然需要进一步打磨才能合并，但将安装程序镜像显著扩展为潜在的救命工具已经触手可及。
...
Olivier Certner <[olce.freebsd.statusreports@certner.fr](mailto:olce.freebsd.statusreports@certner.fr)>
...
- 对于 [mdo(1)](https://man.freebsd.org/cgi/man.cgi?query=mdo&sektion=1&format=html) 组件：
  - 与 [mac_do(4)](https://man.freebsd.org/cgi/man.cgi?query=mac_do&sektion=4&format=html) 的规则相比，目前可以请求的凭证过渡相对有限。将其功能扩展为以下几个方面会很有用：
    ...
    - 仅允许更改组。
    - 在某些情况下，在调用 [setcred(2)](https://man.freebsd.org/cgi/man.cgi?query=setcred&sektion=2&format=html) 前请求口令。这会削弱 [mac_do(4)](https://man.freebsd.org/cgi/man.cgi?query=mac_do&sektion=4&format=html)/[mdo(1)](https://man.freebsd.org/cgi/man.cgi?query=mdo&sektion=1&format=html) 组合的安全范式，因为它将依赖于用户空间来完成部分门控过程，但在许多情况下似乎是可以接受的。
    - 增加一种模式，用于生成与某些用户的口令和组数据库内容相对应的规则目标部分。
...
[工作分支](https://github.com/obiwac/freebsd-s0ix)

**联系方式**：obiwac <[obiwac@freebsd.org](mailto:obiwac@freebsd.org)>

正在将 suspend-to-idle 和对 S0ix 睡眠的支持添加到 FreeBSD 中。
...
[UMB(4) - OpenBSD 设备驱动手册](https://man.openbsd.org/umb)

[UMB(4) - NetBSD 内核接口手册](https://man.netbsd.org/umb.4)

[Bug 263783 - USB MBIM：对 LTE/4G USB 调制解调器的支持](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=263783)

[引入网络驱动程序 USB umb(4)](https://reviews.freebsd.org/D48167)
...
在当前形式下，驱动程序已从原本作为 OPNSense 插件的非内核模块，修改为内核模块及其伴随的二进制文件 umbconfig(8)。这个管理二进制文件有效地允许配置 umb(4) 驱动程序，超出 ifconfig(8) 的功能：可以设置 PIN 和 PUK 代码、APN、用户名/口令和漫游参数，并跟踪连接情况（网络提供商、速度等）。
...
[分类无线问题报告](https://bugs.freebsd.org/bugzilla/showdependencytree.cgi?id=277512&hide_resolved=0)

[驱动概览](https://people.freebsd.org/~bz/wireless/)
...
目前有多个无线项目正在进行，本报告重点介绍了在 FreeBSD 上尽可能直接使用宽松许可的 Linux 无线驱动的工作。
...
已经移植了驱动程序 [rtw89(4)](https://man.freebsd.org/cgi/man.cgi?query=rtw89&sektion=4&format=html) ，它进入源代码有一段时间了，并已成功进入到构建中。感谢社区的努力，之前妨碍其工作的两个 bug 已经解决。

已更新 Ports 中的无线固件，并添加了一个 flavor。已增强发布构建框架，能将固件包安装到发行介质中。安装程序增加了：能在已安装的系统上运行 [fwget(8)](https://man.freebsd.org/cgi/man.cgi?query=fwget&sektion=8&format=html) 来安装固件。这一系列改进确保了可以从安装程序直接使用带有外部固件的（无线）驱动程序，并立即在已安装的系统上运行，无需其他连接方式。通过此框架，后续可以轻松地以类似 iwlwifi(4)、rtw88(4) 和 rtw89(4) 的方式添加更多驱动程序的支持。这些改进首次随 14.2-RELEASE 发布。

在解决了许多前置请求之后，时间用于改进 LinuxKPI 框架中的 HT(802.11n) 和 VHT(802.11ac)，以实现驱动程序和 net80211 之间的同步。硬件加密卸载以及 A-MPDU RX/BA 卸载也在年底前得到了处理。这两项改进对于实现 [iwlwifi(4)](https://man.freebsd.org/cgi/man.cgi?query=iwlwifi&sektion=4&format=html) 更高的吞吐量目标至关重要。
...
Jian-Lin Li <[ljianlin99@gmail.com](mailto:ljianlin99@gmail.com)>
...
[Codeberg 上的仓库](https://codeberg.org/Honeyguide/freebsd-pinephonepro)
...
下一步是启用基于 UEFI 的帧缓冲支持，以启用屏幕输出，启用 USB 即插即用功能，这可能允许插入 USB 键盘/以太网。还将考虑移植 WiFi 的 Linux 驱动程序。鼓励任何有兴趣的人与我们联系。欢迎更多反馈和测试人员。

如果你希望参与，请查看 [FreeBSD 论坛上的此帖](https://forums.freebsd.org/threads/porting-freebsd-to-pinephone-pro-help-needed.95948/)。

**赞助者**：Honeyguide Group
...
[微软 Azure 上的 FreeBSD 文章](https://wiki.freebsd.org/MicrosoftAzure)

[微软 HyperV 上的 FreeBSD 文章](https://wiki.freebsd.org/HyperV)
...
Wei Hu 定位到了在最新 Azure v6 VM SKU 上启动 FreeBSD 时缺失 CDROM 设备的根本原因，因为 V6 类型仅向虚拟机操作系统提供 NVMe 磁盘。他将继续修复 FreeBSD MANA 网卡设备的 bug。
...
**赞助者**：Microsoft（为微软内部人员提供赞助，并为其他人员提供资源）

**赞助者**：FreeBSD 基金会（提供其他所有资源）
...
在第四季度，我们的主要目标是通过建立一个新的环境来最终完成里程碑 1 中承诺的任务，以展示一个可行的概念验证（POC）站点。然而，同时建立另一个基于 FreeBSD Jail 的部署环境，使我们在网络设计和调优上花费了大量时间。幸运的是，我们在本季度末成功建立了物理机上虚拟机的外部网络连接。剩下的挑战是让虚拟机能够通过 `cloud-init` 自动获取 IP 地址。

另外，我们尝试从基于 Linux 的 OpenStack 获取虚拟机的域 XML，以便与用于 bhyve 虚拟机的 XML 进行比较。这些域 XML 由 Libvirt 使用，定义了每个虚拟机的配置和操作参数。比较两者之间的差异有助于开发“bhyve 串口控制台通过 TCP”功能。
...
在 Graviton 系统上，EC2 的 shutdown 和 reboot 操作现在已按预期工作（从 FreeBSD 14.2 开始）。在 Graviton 系统上，热插拔新设备（例如 EBS 卷）在 HEAD 中也能正常工作，相关支持预计将在 FreeBSD 14.3 版本合并。
...
[FreeBSD 文档项目新贡献者指南](https://docs.freebsd.org/en/books/fdp-primer/)
...
[项目 Wiki 页面](https://wiki.freebsd.org/portconfig)

**联系方式**：

FreeBSD 无障碍邮件列表 <[freebsd-accessibility@FreeBSD.org](mailto:freebsd-accessibility@FreeBSD.org)>

Alfonso Sabato Siciliano <[asiciliano@FreeBSD.org](mailto:asiciliano@FreeBSD.org)>

FreeBSD 通过 Ports 为用户和管理员提供了一种简便的应用程序安装方式。Ports 提供了成千上万的 Port；Port 配置是其核心功能之一。在构建和安装之前，可以配置 Port。命令 `make config` 使用文本用户界面（TUI）以交互方式设置 Port 选项。
...
[AppJail GitHub](https://github.com/DtxdF/AppJail)

[Director GitHub](https://github.com/DtxdF/Director)

[LittleJet GitHub](https://github.com/DtxdF/LittleJet)

[Reproduce GitHub](https://github.com/DtxdF/reproduce)

**联系方式**：Jesús Daniel Colmenares Oviedo <[DtxdF@disroot.org](mailto:DtxdF@disroot.org)>

AppJail 是一款基于 BSD-3 许可证的开源框架，完全用 POSIX shell 和 C 编写，用于通过 FreeBSD Jail 创建隔离、便携且易于部署的环境，且这些环境表现得像一个应用程序。

Director 是一款工具，用于通过简单的 YAML 配置文件在 AppJail 上运行多 Jail 环境。Director 文件用于定义构成应用程序的一个/多个 Jail 的配置。有了 Director 文件后，就可以通过命令 `appjail-director up` 来创建并启动应用程序。
...
AppJail 及其所有元项目广泛遵循 [The Ephemeral Concept](https://man.freebsd.org/cgi/man.cgi?query=appjail-ephemeral&apropos=0&sektion=0&manpath=FreeBSD+14.2-RELEASE+and+Ports&arch=default&format=html)，该概念有助于使 Jail 更新/升级变得更加容易，因为它们变得可丢弃。该概念在 AppJail 中实现后，我一直在广泛使用它来部署 Jail 服务。
...
然而，多年来许多问题悄然出现。仅剩一个 CL 实现受支持，即 [SBCL](https://www.sbcl.org/)，而用户遇到了长期存在的 bug，例如 ASDF 版本冲突和加载树外库时的写入错误。此外，由于大多数基础设施代码都包含在 Port [devel/cl-asdf](https://cgit.freebsd.org/ports/tree/devel/cl-asdf/) 中，依赖关系管理非常繁琐。
...
**联系方式**：FreeBSD Erlang 邮件列表 <[erlang@FreeBSD.org](mailto:erlang@FreeBSD.org)>
...
RabbitMQ 用户需要每季度更新，以避免停留在 Erlang/OTP + RabbitMQ 的不受支持版本上，而没有受支持的迁移路径。
...
[项目简介](https://freebsdfoundation.org/project/improving-openjdk-on-freebsd/)

**联系方式**：Harald Eilertsen <[haraldei-fbsd@anduin.net](mailto:haraldei-fbsd@anduin.net)>
...
- 可以在 FreeBSD 上构建和运行 OpenJDK 23，且正将其加入 Ports；这仍然被视为实验性质。[https://reviews.freebsd.org/D48194](https://reviews.freebsd.org/D48194)
...
[Xfce 4.20 上游发布公告](https://xfce.org/about/news/?post=1734220800)

[在 FreshPorts 上的 Xfce 元 Port](https://www.freshports.org/x11-wm/xfce4)

**联系方式**：

Xfce 团队 <[xfce@FreeBSD.org](mailto:xfce@FreeBSD.org)>

Guido Falsi <[madpilot@FreeBSD.org](mailto:madpilot@FreeBSD.org)>

FreeBSD Xfce 团队（xfce@）致力于确保 Xfce 桌面环境在 FreeBSD 上的维护和功能完备。
...
[LXQt 项目 GitHub](https://github.com/lxqt/)

**联系方式**：LXQt 团队 <[lxqt@FreeBSD.org](mailto:lxqt@FreeBSD.org)>
...
如果你维护着任何受影响的 Port，或想帮助准备和测试一些补丁，可以考虑在受影响的 Port 中将 `-fpermissive` 添加到 `CFLAGS` 作为临时解决方案：GCC 14 将一些警告转化为错误，这是导致许多构建失败的原因。参数 `-fpermissive` 会将这些错误转换回警告。然而，更好的方法是让上游更新其代码，以完全消除这些警告，从而不再需要 `-fpermissive`，可能需要 FreeBSD Ports 维护人员的支持。如果上游不再维护代码，可能是时候弃用该 Port 了。
...
[GitLab 仓库](https://gitlab.torproject.org/tpo/applications/tor-browser)
...
此更新包含了对 Firefox 的重要安全更新，确保用户能够受益于增强的安全性和隐私功能。扩大 FreeBSD 兼容性仍然是优先事项，以便为平台提供无缝且原生的隐私解决方案。
...
Greenbone Community Edition (GVM) 包含 Greenbone Vulnerability Management 软件栈的实际源代码，也被称为 OpenVAS 扫描器，它提供了 160,000 多个漏洞测试的安全源、一款漏洞管理应用程序等。
...
[Bhyvemgr](https://github.com/alonsobsd/bhyvemgr)

**联系方式**：José Alonso Cárdenas Márquez <[acm@FreeBSD.org](mailto:acm@FreeBSD.org)>

Bhyvemgr 是一款在 FreeBSD 上用 Freepascal/Lazarus 编写的 bhyve 管理 GUI。它需要一组主要安装在基本系统上的工具，以及一些从 Ports/软件包安装的工具。该应用程序旨在帮助桌面用户轻松快捷地在 FreeBSD 主机上设置和运行虚拟机。

在本季度，对 Bhyvemgr 进行了许多 bug 修复和改进。

添加的部分新功能包括：

- 能在 CURRENT 上通过软件 (swtpm) 使用可信平台模块 (TPM)
- 支持 Bootvars
- 可修改 BIOS、系统、主板和机箱信息
- 几乎所有桌面环境都支持系统托盘图标（已在 Plasma、Gnome、Xfce、LXQt 和 IceWM 中测试）
...
**联系方式**：Maksym Sobolyev <[sobomax@FreeBSD.org](mailto:sobomax@FreeBSD.org)>

**链接**：

[项目页面](https://github.com/sobomax/qemu-bsd-user-l4b)

[工具集](https://github.com/sobomax/qemu_l4b)

`bsd-user-4-linux` 项目将 QEMU 的 BSD 用户模式仿真移植到 Linux。主要目标是在现代 Linux 系统上运行未修改的 FreeBSD 二进制文件。此外，该项目还旨在提供多平台容器镜像，包含功能完备的 FreeBSD 环境和现成的 GitHub Actions 模板。
...
[维基页面](https://wiki.freebsd.org/LaptopDesktopWorkingGroup)

**联系方式**：Chris Moerz <[freebsd@ny-central.org](mailto:freebsd@ny-central.org)>

2024 年 10 月，笔记本电脑和桌面工作组 (LDWG) 正式成立，并亲切地被称为“Ludwig”。这一倡议为社区提供了一个协作平台，旨在促进开发、测试、知识交流和 FreeBSD 在笔记本电脑和台式电脑上的推广。欢迎所有有兴趣的人加入。
...
2024 年 11 月 16 日，LDWG 举行了首次虚拟会议。参与者包括开发者、贡献者、Discord 社区管理员、用户和 FreeBSD 基金会成员，体现了 FreeBSD 在笔记本电脑和台式机上的广泛兴趣。会议幻灯片、会议纪要和录音可在工作组的 [维基页面](https://wiki.freebsd.org/LaptopDesktopWorkingGroup) 查阅。
...
工作组正在进行一项 [在线调查](https://docs.google.com/forms/d/e/1FAIpQLSd6-AOHpnae4o40CSr0tt6GlmfgfP7A9REdulJmPw9Nn0Uo_w/viewform?usp=sf_link)，以收集非参与者的反馈。调查将持续到 1 月的下次线上会议，届时将呈现并讨论结果。
...
最后，所有镜像已经多次重建：针对 FreeBSD 14.1，包含了安全修复，然后针对 14.2 和新的季度软件包再次重建。

一如既往，欢迎提供反馈和补丁。

**赞助者**：Nikulipe UAB，Honeyguide Group
