...
[谷歌编程之夏 2024 - 改进带修复和升级能力的安装程序 (#1395)](https://github.com/freebsd/freebsd-src/pull/1395)
...
在 Graviton 系统上，EC2 的 shutdown 和 reboot 操作现在已按预期工作（从 FreeBSD 14.2 开始）。在 Graviton 系统上，热插拔新设备（例如 EBS 卷）也能正常工作，相关支持预计将在 FreeBSD 14.3 版本合并。
...
`bsd-user-4-linux` 项目将 BSD 用户模式仿真移植到 Linux。主要目标是在现代 Linux 系统上运行未修改的 FreeBSD 二进制文件。此外，该项目还旨在提供多平台容器镜像，包含功能完备的 FreeBSD 环境和现成的 GitHub Actions 模板。
