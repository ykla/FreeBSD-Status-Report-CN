...
AppJail 及其所有元项目广泛遵循 [The Ephemeral Concept](https://man.freebsd.org/cgi/man.cgi?query=appjail-ephemeral&apropos=0&sektion=0&manpath=FreeBSD+14.2-RELEASE+and+Ports&arch=default&format=html)，该概念有助于使 Jail 更新/升级变得更加容易，因为它们变得可以丢弃。该概念在 AppJail 中实现后，我一直在广泛使用它来部署 Jail 服务。
