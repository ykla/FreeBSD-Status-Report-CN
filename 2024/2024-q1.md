...
FreeBSD 的音频栈长期以来未受到足够的关注和开发，尽管质量很高，但仍有改进空间，包括缺乏音频开发框架、缺少用户空间实用工具以及内核驱动相关的缺陷等。此项目旨在涵盖这些方面，更多是一个总体改进项目，而非实现特定功能。

目前我的重点是音频栈的内核部分，最受关注的补丁可能是 [D43545](https://reviews.freebsd.org/D43545)。我也正在计划移除过时的 [sound(4)](https://man.freebsd.org/cgi/man.cgi?query=sound&sektion=4&format=html) 中的“snd_clone”音频设备克隆框架，并以 DEVFS_CDEVPRIV(9) 取而代之 ([D44411](https://reviews.freebsd.org/D44411))。
...
FreshPorts 和 FreshSource 已经持续报告 FreeBSD 提交信息超过 20 年，涉及了所有提交内容，不仅仅是 Ports。
