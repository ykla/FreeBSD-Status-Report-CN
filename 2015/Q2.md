...
这个实验的希望是，以最小的对用户和他们当前构建脚本和流程的影响，为在 FreeBSD 11 中使用更优的硬浮点铺平道路。如果用户需要在 FreeBSD 11.0 上运行 FreeBSD 10.X ARMv6 软浮点二进制文件，将确保与 libsoft 任务的向后兼容性。一旦新的硬浮点包投入使用，包应自动更新。
