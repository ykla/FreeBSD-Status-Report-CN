...
在本季度，共发布了三个新的提交权限（commit bits），并且有一个提交权限被暂时归还以备保存。请欢迎 Wojciech Macek、Jared McNeil 和 Stanislav Galabov，向 Davide Italiano 告别，尽管他因太忙而无法直接参与 FreeBSD 工作，但他仍将通过上游的 lld 和其他工具链部分做出贡献。
