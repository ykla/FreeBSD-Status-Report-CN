...
### [GCC (GNU 编译程序集合)](https://www.freebsd.org/status/report-2016-10-2016-12.html#GCC-(GNU-Compiler-Collection))
...
（是的，这意味着我们应该尽快为 lang/gcc 完成下一个版本的升级。此更新本身是简单的，但任何在处理破损 ports 时提供的帮助都将非常有用——如果你愿意帮忙，请告诉我们！）
