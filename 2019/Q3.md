...
### [FreeBSD 发布工程团队](https://www.freebsd.org/status/report-2019-07-2019-09.html#FreeBSD-Release-Engineering-Team)
...
Intel已将 TPM2 软件栈的移植版本贡献至 FreeBSD ports 代码库，新增的 ports 包括 `security/tpm2-tss`、`security/tpm2-tools` 和 `security/tpm2-abrmd`。
...
### [Nomad pot 驱动程序 - 通过 nomad 编排 Jail](https://www.freebsd.org/status/report-2019-07-2019-09.html#Nomad-pot-driverOrchestrating-jails-via-nomad)
