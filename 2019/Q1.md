...
FreeBSD 基金会是一家 501(c)(3) 非营利组织，致力于在全球范围内支持和推广 FreeBSD 项目及其社区。资金来源于个人和企业捐赠，并用于资助和管理软件开发项目、会议及开发者峰会，并为 FreeBSD 贡献者提供旅行资助。  
...
基金会通过雇佣技术人员来维护和改进 FreeBSD 的关键内核子系统，增加新功能并修复问题。此外，我们还资助了多个独立项目，例如 arm64 平台移植、blacklistd 访问控制守护进程移植，以及 VIMAGE 支持的集成，以确保 FreeBSD 在研究、教育、计算及产品开发领域保持竞争力。  

本季度，由基金会资助的 9 名开发人员和项目受资助者共提交了 **241 次代码提交**。  
...
对 Ports Collection 产生影响的变更，无论是涉及整个 Ports 的大范围更新，还是针对个别 ports 的调整。
