...
### [Clang 替代 GCC 作为基本系统编译程序](https://www.freebsd.org/status/report-2011-04-2011-06.html#Clang-replacing-GCC-in-the-base-system)
...
除了通常对 ARM、i386 和 amd64 的改进外，Mips 和 PowerPC 方面也取得了一些进展。我们已经成功让 clang 编译的 ARM 内核启动。ARM 世界目前受到 FreeBSD 使用旧 ARM ABI 的阻碍。
...
### [IPv6 RA 处理改进](https://www.freebsd.org/status/report-2011-04-2011-06.html#IPv6-RA-Handling-Improvements)
...
### [FreeBSD 日文文档项目](https://www.freebsd.org/status/report-2011-04-2011-06.html#The-FreeBSD-Japanese-Documentation-Project)
...
## [架构](https://www.freebsd.org/status/report-2011-04-2011-06.html#Architectures)
...
一些基本系统的应用程序已获得沙盒支持，目前的任务是将轻量级解析守护进程适配到沙盒中——这解决了需要在沙盒中将 IP 地址转换为域名的应用程序的问题。
