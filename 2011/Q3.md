...
Ports 管理团队一直在持续进行 -exp 运行，验证基本系统更新如何影响 Ports，并为主要的 Port 更新提供质量保证测试。值得注意的是，进行了以下 -exp 运行：
...
**链接**：<http://wiki.FreeBSD.org/AdrianChadd/AtherosTxAgg>
...
**链接**：[冲刺期间记录的结果和笔记](http://people.FreeBSD.org/~bcr/doc/sprints/20110905-final.html)
