...
FreeBSD 上的 KDE 项目为 FreeBSD ports 树打包 KDE 社区的软件，以及依赖项和相关软件。该软件包括完整桌面环境 KDE Plasma（支持 X11 和 Wayland），以及数百个可在任何 FreeBSD 机器上使用的应用程序。
