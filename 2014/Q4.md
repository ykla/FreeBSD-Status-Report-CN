...
- 原文：[FreeBSD Quarterly Status Report 4th Quarter 2014](https://www.freebsd.org/status/report-2014-10-2014-12.html)
- 最后作者：FreeBSD 项目
...
这一季度也是工具链的活跃期，编译程序、调试器和其他组件进行了大量改进，包括对 C++14 的初步支持，预计在 FreeBSD 10.2 中完成。
