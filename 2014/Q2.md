...
ZFSguru 是多功能服务器设备，强调存储功能。ZFSguru 最初是简单的 ZFS Web 界面前端，但后来发展成为具有自己基础设施的 FreeBSD 衍生版。随着项目的扩展，增加了附加软件包，提供了超越传统 NAS 功能的功能，这些功能类似于 FreeNAS 和 NAS4Free。ZFSguru 旨在成为真正的多功能服务器设备，极易设置，并能将初学者和更有经验的用户结合在同一用户界面中。项目的模块化特点避免了臃肿的风险，同时仍然能轻松部署扩展功能。
