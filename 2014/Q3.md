...
### [FreeBSD 的 Jenkins 持续集成](https://www.freebsd.org/status/report-2014-07-2014-09.html#Jenkins-Continuous-Integration-for-FreeBSD)
...
另外，新的协作开发平台也在筹备中。为 GitLab 项目创建了一个服务附加包，GitLab 是流行的 GitHub 网站的替代品。我们选择托管自己的解决方案，而不是依赖 GitHub。回顾来看，这个决定证明是正确的。最近 GitHub 因 DMCA 下架项目的开发趋势，与 ZFSguru 项目所提倡的信息自由流动理念不符。通过托管我们自己的解决方案，我们避免了对第三方项目的依赖。
