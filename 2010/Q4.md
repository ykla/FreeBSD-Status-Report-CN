...
1. 我希望今年获得一个 Google Summer of Code 项目，构建默认的 Linux Kernel 2.6.37+ 并允许在 FreeBSD 下使用相关的 Linux USB 设备驱动程序。Webcamd 不是本地 FreeBSD 内核驱动程序的替代品，仅在没有现有 FreeBSD 驱动程序的设备上使用，避免任何 GPLv2 问题。如果你是学生或有兴趣参与此类项目，欢迎通过电子邮件联系 hselasky@FreeBSD.org。
