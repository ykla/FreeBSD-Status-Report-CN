...
1. 各个小组之间的协调，以支持即将发布的 12.0 版本。OpenSSL 1.1.1 的发布时间带来了挑战。新的 OpenSSL 版本包含了 API 更改，因此许多基本系统和 Ports 需要进行相应的更改。在 12.0 中继续使用旧版 OpenSSL 并不可行，因为这意味着需要向一个上游已不再维护的 OpenSSL 版本向后移植许多更改。
