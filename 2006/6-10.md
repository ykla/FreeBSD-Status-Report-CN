...
此外，Ryan Beasley 作为 2006 年谷歌编程之夏计划的一部分所做的工作已经提交。这为 Open Sound System（OSS）v4 API 添加了兼容性，尽可能地扩展了功能。这使得可以编写更复杂的程序。例如，现在可以同步多个声音通道的启动。驱动程序还可以支持不止 AC97 混音设备，但目前还没有驱动程序扩展以支持这一点。更多信息可以在 Wiki 和官方 OSS 文档中找到。
