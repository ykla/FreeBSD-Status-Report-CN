...
我们继续推进将 2011 年谷歌 Code-In 项目的成果提交到 FreeBSD 项目中的工作；相关进展的概述请见 [http://wiki.freebsd.org/GoogleCodeIn/2011Status](http://wiki.freebsd.org/GoogleCodeIn/2011Status)。鼓励文档提交者和 GCIN 导师查看此列表并帮助将未完成的任务提交到代码库。
...
该项目的主要目标是创建研究平台，用于探讨一系列与多路径相关的传输问题，包括拥塞控制、重传策略和数据包调度策略。我们还旨在与在洛万大学开发的 Linux 内核实现保持完全的互操作性。
