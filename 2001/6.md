...
新增驱动程序 digi。由 John Prince <johnp@knight-trosoft.com> 完成初步工作，但由我完成所有模块化相关的工作，同时也对 Xe 和 Xi 设备（类似 dgb）添加了初步支持。我目前正在等待 Joerg@（几乎是免费赠送）寄来的 Xe 设备，来让这部分功能正常运行。
...
## [TrustedBSD Capabilities](https://www.freebsd.org/status/report-2001-06.html#TrustedBSD-Capabilitiess)
