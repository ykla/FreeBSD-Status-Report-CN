...
我们自豪地宣布 FreeBSD Haskell 团队已经将现有的 Port 更新为最新的稳定版本。我们还增加了一些新的 Port，使 FreeBSD Ports 中的 Haskell Port 数量超过 400，涉及了许多流行的软件，如 xmonad、git-annex、pandoc 或各种 Web 框架实现。所有这些更新将在即将发布的 8.4-RELEASE 中提供。我们还了解到，Haskell Port 在 DragonFlyBSD 的 dports 树中也成功使用。
