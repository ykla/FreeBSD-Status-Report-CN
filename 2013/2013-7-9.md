...
大量的工作集中在调整和改进基础设施，以进行现代化更新，为 pkg(8) 替换旧的 pkg_add(1) 基础设施做准备，同时也为 FreeBSD 10.0 做准备，采用 Clang 作为默认编译程序，libc++ 作为默认 C++ 标准库，以及将 iconv(1) 集成到 libc 中。
...
### [FreeBSD 发行工程团队](https://www.freebsd.org/status/report-2013-07-2013-09.html#FreeBSD-Release-Engineering-Team)
