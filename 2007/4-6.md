...
**ATI HDTV Wonder** —— 在多年尝试加入 ATI 开发者计划后，他们终于暂停了该计划，因此无法获得 ATI 的支持。我已开始为 Conexant CX2388x 基础的卡片开发驱动程序 cxd。ATI HDTV Wonder 使用 ATI 自己的解调器，我在借鉴 Linux 驱动的基础上让它能够调谐。捕捉时，我得到了有效数据，但并不是所有数据。由于 ATI 和 linux-dvb 缺乏支持，该项目已无限期搁置。
