...
**赞助者**：FreeBSD 基金会（赞助許立文和 Sheng-Yi 的工作）

**赞助者**：Framework Computer Inc（赞助 Daniel 的工作、硬件和场地支持）
...
**赞助者**：Christoff Visser 和 Internet Initiative Japan Inc.（场地提供）
...
Igor Ostapenko <[igoro@FreeBSD.org](mailto:igoro@FreeBSD.org)>
...
FreeBSD Accessibility 邮件列表 <[freebsd-accessibility@FreeBSD.org](mailto:freebsd-accessibility@FreeBSD.org)>
