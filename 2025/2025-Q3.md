...
许多新加入的成员都会带着这样的问题来找我们：“我该如何开始？”这里不是回答这个问题的地方，但实际上已经有一份指南专门为此编写。你可以在[这里](https://docs.freebsd.org/en/articles/contributing/)找到它。此外，时刻记住：尽可能地多使用 FreeBSD，会带来很大帮助：将它作为你的主力系统，用它运行 Web 服务器，在虚拟机上安装它，在给现有软件做贡献时也支持它！如果你发现了 bug，也不要忘记[报告](https://bugs.freebsd.org/bugzilla/)它们。
