...
**赞助者**：Tarsnap
**赞助者**：[https://www.gofundme.com/f/gjbbsd/](https://www.gofundme.com/f/gjbbsd/)
**赞助者**：FreeBSD 基金会
...
**赞助者**：Kumacom SAS（进行开发工作）
**赞助者**：FreeBSD 基金会（进行一些审查）
...
**赞助者**：Kumacom SAS（开发工作）
**赞助者**：FreeBSD 基金会（大部分审查）
...
**赞助者**：Traverse Technologies（提供 Ten64 硬件进行测试）
...
[freebsd-cloud 邮件列表](https://lists.freebsd.org/mailman/listinfo/freebsd-cloud)
...
**赞助者**：对于 Microsoft 的人员和为其他方提供资源的一切，由 FreeBSD 基金会赞助。
...
Yan-Hao Wang <[bses30074@gmail.com](mailto:bses30074@gmail.com)>
...
该仓库包含文件 **elementary.mk**，用于 **Mk/Uses** 框架、官方应用程序和依赖于 [x11-toolkits/granite7](https://cgit.freebsd.org/ports/tree/x11-toolkits/granite7/) 的精选 Port。
...
FreeBSD Office 团队 ML <[office@FreeBSD.org](mailto:office@FreeBSD.org)>
